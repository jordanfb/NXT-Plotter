# in order to pair to NXT I had to run:
# sudo rfcomm connect hci0 00:16:53:0B:55:3E
# where the characters at the end are the bluetooth ID shown in bluetoothctl
# jk actually I installed a bunch of fucking things that don't seem to change anything?
# I think I started with it not connected and then it worked finally? I installed bluetooth, bluez, and blueman using apt, but idk if those helped
...
def open_test_gcode_file():
    f = open("/home/pi/Documents/scripts/PlotterFiles/test_spiral.gcode")
    l = f.read()
    return l
